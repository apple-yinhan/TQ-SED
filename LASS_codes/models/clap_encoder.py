...
class CLAP_Encoder(nn.Module):
    def __init__(
        ...
        pretrained_path='/mnt/nfs2/hanyin/LASS4SED/pretrained_models/clap/music_speech_audioset_epoch_15_esc_89.98.pt', 
        ...
        # ! set correct path
        self.tokenize = RobertaTokenizer.from_pretrained("/mnt/nfs2/hanyin/LASS4SED/pretrained_models/robera-base")
